        ...
        try
        {
            if (!string.IsNullOrEmpty(verificationRequest.Email) && !string.IsNullOrEmpty(code))
            {
                var emailRequest = new EmailRequest()
                {
                        ...
                        <body>
                            <div style='color: #191919; max-width: 500px'>
                                ...
                                <div style='background-color: #f4f4f4; padding 1rem 2rem; '>
                                        <p>Dear user,</p>
                                        <p>We recieved a request to sign in to your account using e-mail {verificationRequest.Email}. Please verify your account using this verification code:</p>
                                    ...
                                    <div class='noreply' style='color: #191919; font-size: 11px; '>
                                        <p>If you did not request this code, it is possible that somebody else is trying to access your account<span style='color: #0041cd; '> {verificationRequest.Email}.</span>This email can't recieve replies. For more information visit our help center</p>
                                    </div>
                                </div>
                    ...
                    ",
                    PlainText = $"Please verify your account using this verification code: {code} If you did not request this code, it is possible that somebody else is trying to access your account {verificationRequest.Email}.This email can't recieve replies. For more information visit our help center"
                };
